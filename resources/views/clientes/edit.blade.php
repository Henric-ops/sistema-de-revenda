                    ...
                    <div class="field">
                        ...
                        <div class="field-wrap">
                            <input type="text" id="nome" name="nome" placeholder="Ex: Maria da Silva"
                                value="{{ old('nome', $cliente->nome) }}" maxlength="100" required>
                        </div>
                        @error('nome')
                    ...
                    <div class="field">
                        ...
                        <div class="field-wrap">
                            <input type="text" id="celular" name="celular" placeholder="(55) 99999-9999"
                                value="{{ old('celular', $cliente->celular) }}" maxlength="20" required>
                        </div>
                        @error('celular')
                            <div class="field-error">
                                <i class="bi bi-exclamation-circle"></i> {{ $message }}
                    ...
                    <div class="field">
                        ...
                        <div class="field-wrap">
                            <textarea id="observacoes" name="observacoes" rows="4"
                                ...
                                maxlength="500">{{ old('observacoes', $cliente->observacoes) }}</textarea>
                        </div>

                        <div class="field-footer">
                            <span class="char-count" id="char-count">{{ strlen($cliente->observacoes ?? '') }} / 500</span>
                        </div>
